...
function getChildMapping(children2, mapFn) {
  ...
  if (children2) import_react4.Children.map(children2, function(c3) {
    return c3;
...
function l(t3, e3) {
  ...
  if (null != t3 && "function" == typeof Object.getOwnPropertySymbols) {
    var r3 = 0;
    for (i3 = Object.getOwnPropertySymbols(t3); r3 < i3.length; r3++) e3.indexOf(i3[r3]) < 0 && Object.prototype.propertyIsEnumerable.call(t3, i3[r3]) && (n3[i3[r3]] = t3[i3[r3]]);
  }
  return n3;
}
...
var T = (0, import_react8.forwardRef)((e3, n3) => {
  ...
  const Y = (t3) => (e4) => {
    ...
    } else t3.style.transitionDuration = "string" == typeof i3 ? i3 : `${i3}ms`;
    ...
    } else t3.style.transitionDuration = "string" == typeof n4 ? n4 : `${n4}ms`;
...
function c2(e3, r3) {
  var t3 = {};
  for (var o2 in e3) Object.prototype.hasOwnProperty.call(e3, o2) && r3.indexOf(o2) < 0 && (t3[o2] = e3[o2]);
  if (null != e3 && "function" == typeof Object.getOwnPropertySymbols) {
    var i3 = 0;
    for (o2 = Object.getOwnPropertySymbols(e3); i3 < o2.length; i3++) r3.indexOf(o2[i3]) < 0 && Object.prototype.propertyIsEnumerable.call(e3, o2[i3]) && (t3[o2[i3]] = e3[o2[i3]]);
  }
  return t3;
}
...
var m2 = (o2) => {
  var { error: i3, loader: l3, onLoad: d3, onError: p3, objectFit: m3 = "cover", Transition: g3 = O, timeout: O2 = 1e3, sources: y2 = [], inView: j2 } = o2, f2 = c2(o2, ["error", "loader", "onLoad", "onError", "objectFit", "Transition", "timeout", "sources", "inView"]);
  const [h2, v2] = (0, import_react9.useState)(u2.LOADING);
  return (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [(0, import_jsx_runtime2.jsx)(O, { appear: false, in: h2 === u2.LOADING, timeout: O2, unmountOnExit: true, children: (0, import_react9.cloneElement)(l3, { style: Object.assign(Object.assign({}, l3.props.style), b2) }) }), j2 && (0, import_jsx_runtime2.jsx)(g3, { in: h2 === u2.LOADED, timeout: O2, children: (0, import_jsx_runtime2.jsxs)("picture", { style: b2, children: [y2.map((r3) => (0, import_jsx_runtime2.jsx)("source", Object.assign({}, r3), r3.srcSet)), (0, import_jsx_runtime2.jsx)("img", Object.assign({}, f2, { className: "AsyncImage-image", style: Object.assign({ objectFit: m3 }, b2), onLoad: (e3) => {
    v2(u2.LOADED), null == d3 || d3(e3);
  }, onError: (e3) => {
    v2(u2.FAILED), null == p3 || p3(e3);
  } }))] }) }), (0, import_jsx_runtime2.jsx)(g3, { in: h2 === u2.FAILED, timeout: O2, mountOnEnter: true, unmountOnExit: true, children: (0, import_react9.cloneElement)(i3, { style: Object.assign(Object.assign({}, i3.props.style), b2) }) })] });
};
var g2 = (r3) => {
  ...
  return (0, import_jsx_runtime2.jsx)(InView, { rootMargin: n3, triggerOnce: true, children: ({ ref: r4, inView: o2 }) => {
    var n4;
    return (0, import_jsx_runtime2.jsx)(l2, { ref: r4, className: b3, style: a, children: (0, import_jsx_runtime2.jsx)(m2, Object.assign({ error: i3, loader: t3, objectFit: null !== (n4 = a.objectFit) && void 0 !== n4 ? n4 : s3, inView: o2 }, u3)) });
  } });
};
export {
  g2 as AsyncImage
